...
describe('PodcastComponent', () => {
    ...
    TestBed
        .configureTestingModule({
          ...
          imports: [
            ...
            StoreModule.forRoot({}), StoreModule.forFeature('podcast', fromPodcast.reducer),
  ...
  it('should have a cover displayed', async () => {
    ...
    /* Then  */
    expect(jumbotron.styles['background-image'])
        .toEqual('url(/api/podcasts/94b65e37-24ad-4297-b7bc-e4324a6dc0ed/cover.jpg)');
  });
