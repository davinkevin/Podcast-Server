...
fdescribe('SearchComponent', () => {
  ...
  fit('should have resolver value attached after init', () => {
    /* Given */
    fixture.whenStable().then(() => {
      /* When  */
      let elements = el.queryAll(By.css('md-card'));
      /* Then  */
