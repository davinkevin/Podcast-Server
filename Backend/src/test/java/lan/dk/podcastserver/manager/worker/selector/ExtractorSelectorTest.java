...
import lan.dk.podcastserver.manager.worker.extractor.PassThroughExtractor;
...
import static lan.dk.podcastserver.manager.worker.selector.ExtractorSelector.NO_OP_EXTRACTOR;
