...
public class PlaylistRecord extends UpdatableRecordImpl<PlaylistRecord> implements Record2<UUID, String> {
    ...
    @Override
    public PlaylistRecord values(UUID value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
