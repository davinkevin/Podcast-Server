...
public class Keys {
    ...
    public static final ForeignKey<ItemRecord, CoverRecord> ITEM__ITEM_COVER_ID_FKEY = Internal.createForeignKey(Item.ITEM, DSL.name("item_cover_id_fkey"), new TableField[] { Item.ITEM.COVER_ID }, Keys.COVER_PKEY, new TableField[] { Cover.COVER.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ItemRecord, PodcastRecord> ITEM__ITEM_PODCAST_ID_FKEY = Internal.createForeignKey(Item.ITEM, DSL.name("item_podcast_id_fkey"), new TableField[] { Item.ITEM.PODCAST_ID }, Keys.PODCAST_PKEY, new TableField[] { Podcast.PODCAST.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PlaylistRecord, CoverRecord> PLAYLIST__PLAYLIST_COVER_ID_FK = Internal.createForeignKey(Playlist.PLAYLIST, DSL.name("playlist_cover_id_fk"), new TableField[] { Playlist.PLAYLIST.COVER_ID }, Keys.COVER_PKEY, new TableField[] { Cover.COVER.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PlaylistItemsRecord, ItemRecord> PLAYLIST_ITEMS__PLAYLIST_ITEMS_ITEMS_ID_FKEY = Internal.createForeignKey(PlaylistItems.PLAYLIST_ITEMS, DSL.name("playlist_items_items_id_fkey"), new TableField[] { PlaylistItems.PLAYLIST_ITEMS.ITEMS_ID }, Keys.ITEM_PKEY, new TableField[] { Item.ITEM.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PlaylistItemsRecord, PlaylistRecord> PLAYLIST_ITEMS__PLAYLIST_ITEMS_PLAYLISTS_ID_FKEY = Internal.createForeignKey(PlaylistItems.PLAYLIST_ITEMS, DSL.name("playlist_items_playlists_id_fkey"), new TableField[] { PlaylistItems.PLAYLIST_ITEMS.PLAYLISTS_ID }, Keys.PLAYLIST_PKEY, new TableField[] { Playlist.PLAYLIST.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PodcastRecord, CoverRecord> PODCAST__PODCAST_COVER_ID_FKEY = Internal.createForeignKey(Podcast.PODCAST, DSL.name("podcast_cover_id_fkey"), new TableField[] { Podcast.PODCAST.COVER_ID }, Keys.COVER_PKEY, new TableField[] { Cover.COVER.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PodcastTagsRecord, PodcastRecord> PODCAST_TAGS__PODCAST_TAGS_PODCASTS_ID_FKEY = Internal.createForeignKey(PodcastTags.PODCAST_TAGS, DSL.name("podcast_tags_podcasts_id_fkey"), new TableField[] { PodcastTags.PODCAST_TAGS.PODCASTS_ID }, Keys.PODCAST_PKEY, new TableField[] { Podcast.PODCAST.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PodcastTagsRecord, TagRecord> PODCAST_TAGS__PODCAST_TAGS_TAGS_ID_FKEY = Internal.createForeignKey(PodcastTags.PODCAST_TAGS, DSL.name("podcast_tags_tags_id_fkey"), new TableField[] { PodcastTags.PODCAST_TAGS.TAGS_ID }, Keys.TAG_PKEY, new TableField[] { Tag.TAG.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
}
