...
public class WatchListItemsRecord extends UpdatableRecordImpl<WatchListItemsRecord> implements Record2<UUID, UUID> {
    ...
    public Field<UUID> field1() {
        return WatchListItems.WATCH_LIST_ITEMS.WATCH_LISTS_ID;
    }

    @Override
    public Field<UUID> field2() {
        return WatchListItems.WATCH_LIST_ITEMS.ITEMS_ID;
    }

    @Override
    public UUID component1() {
        return getWatchListsId();
    }
    ...
    @Override
    public WatchListItemsRecord value1(UUID value) {
        setWatchListsId(value);
        return this;
    }

    @Override
    public WatchListItemsRecord value2(UUID value) {
        setItemsId(value);
        return this;
    }

    @Override
    public WatchListItemsRecord values(UUID value1, UUID value2) {
        value1(value1);
        value2(value2);
        return this;
    }
