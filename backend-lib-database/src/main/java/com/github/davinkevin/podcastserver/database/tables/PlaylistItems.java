...
public class PlaylistItems extends TableImpl<PlaylistItemsRecord> {
    ...
    public PlaylistItems where(Condition condition) {
        return new PlaylistItems(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public PlaylistItems whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public PlaylistItems whereNotExists(TableLike<?> select) {
