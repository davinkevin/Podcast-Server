...
public class PodcastTags extends TableImpl<PodcastTagsRecord> {
    ...
    public PodcastTags where(Condition condition) {
        return new PodcastTags(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public PodcastTags whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public PodcastTags whereNotExists(TableLike<?> select) {
