...
class PlaylistRepositoryTest(
    ...
    inner class ShouldDelete {
        ...
        fun `by id with no items`() {
            ...
            assertThat(query.selectCount().from(PLAYLIST).r2dbc().fetchOne(count())).isEqualTo(2)
            assertThat(query.selectCount().from(PLAYLIST_ITEMS).r2dbc().fetchOne(count())).isEqualTo(3)
        }
        ...
        fun `by id with items`() {
            ...
            assertThat(query.selectCount().from(PLAYLIST).r2dbc().fetchOne(count())).isEqualTo(2)
            assertThat(query.selectCount().from(PLAYLIST_ITEMS).r2dbc().fetchOne(count())).isEqualTo(1)
        }
    }
