...
public class SignatureTest {
    ...
    public void initTest() {
        podcastList.add(new Podcast("Cauet", "http://www.youtube.com/channel/UCe2YQ986DdKliHNvE8va4kQ", "", "Youtube", null, null, new Cover()));
        podcastList.add(new Podcast("Will & Co", "http://www.youtube.com/channel/UCzMawL8sevUd5nZ14x4wRpg", "", "Youtube", null, null, new Cover()));
        podcastList.add(new Podcast("Geek Inc HD", "http://www.geekinc.fr/rss/geek-inc-hd.xml", "", "RSS", new Timestamp(System.currentTimeMillis()), null, null));
        podcastList.add(new Podcast("PodMyDev", "http://pipes.yahoo.com/pipes/pipe.run?URL=http%3A%2F%2Fwww.podmydev.com%2F%3Ffeed%3Dpodcast&_id=1c04fdbe524a909e33308bc4fab9d5ae&_render=rss", "", "RSS", new Timestamp(System.currentTimeMillis()), null, null));
        podcastList.add(new Podcast("TWIG", "http://feeds.twit.tv/twig_video_hd", "", "RSS", new Timestamp(System.currentTimeMillis()), null, null));
        podcastList.add(new Podcast("Le Petit Journal", "http://www.canalplus.fr/c-divertissement/c-le-petit-journal/pid6515-l-emission.html",
                "", "CanalPlus", null, null, new Cover("http://media7.canal-plus.net/image/25/2/319252.jpg", 60, 60)));
        podcastList.add(new Podcast("La Météo de Doria", "http://www.canalplus.fr/c-divertissement/c-le-grand-journal/pid4688-la-meteo-de-doria.html",
                "", "CanalPlus", null, null, new Cover("http://media7.canal-plus.net/image/64/4/321644.jpg", 60, 60)));
        podcastList.add(new Podcast("L'instant Barré", "http://www.canalplus.fr/lib/front_tools/ajax/wwwplus_live_onglet.php?pid=3847&ztid=5810&nbPlusVideos1=1",
                "", "CanalPlus", null, null, new Cover("http://img15.hostingpics.net/pics/966069Capture20131020092150.png", 60, 60)));
