            ...
            },
            {
                ...
                value: function remove(item) {
                    ...
                    return item.remove().then(function () {
                        ...
                        _this4.$location.path('/podcast/'.concat(_this4.item.podcast.id));
                    });
                }
            },
            {
            ...
            },
            {
                ...
                value: function save() {
                    ...
                    this.podcastService.save(this.podcast).then(function (podcast) {
                        return _this7.$location.path('/podcast/' + podcast.id);
                    });
                }
            }
        ]);
        ...
        _createClass(itemService, [
            {
                ...
                value: function search() {
                    ...
                    return this.Restangular.one('item/search').post(null, searchParameters).then(function (responseFromServer) {
                        responseFromServer.content = _this12.restangularizedItems(responseFromServer.content);
            ...
            },
            {
                ...
                value: function restangularizedItems(itemList) {
                    ...
                    angular.forEach(itemList, function (value) {
                        restangularList.push(_this13.Restangular.restangularizeElement(_this13.Restangular.one('podcast', value.podcastId), value, 'items'));
                    });
            ...
            },
            {
                ...
                value: function save() {
                    ...
                    return this.podcastService.patch(podcastToUpdate).then(function (patchedPodcast) {
                        return _.assign(_this14.podcast, patchedPodcast);
                    }).then(function () {
                        return _this14.$scope.$emit('podcastEdition:save');
                    });
                }
            },
            {
                ...
                value: function deletePodcast() {
                    ...
                    return this.podcastService.deletePodcast(this.podcast).then(function () {
                        return _this15.$location.path('/podcasts');
                    });
                }
            }
        ]);
    ...
    var podcastItemsListCtrl = function () {
        function podcastItemsListCtrl($scope, DonwloadManager, PodcastItemPerPage, itemService, playlistService) {
            ...
            this.DownloadManager.ws.subscribe('/topic/podcast/'.concat(this.podcast.id), function (message) {
                return _this16.onMessageFromWS(message);
            }, $scope);
        }
            ...
            },
            {
                ...
                value: function loadPage() {
                    ...
                    return this.itemService.getItemForPodcastWithPagination(this.podcast, {
                        ...
                        _this17.podcast.items = _this17.itemService.restangularizePodcastItem(_this17.podcast, itemsResponse.content);
                        _this17.podcast.totalItems = itemsResponse.totalElements;
                    });
                }
            },
            {
                ...
                value: function remove(item) {
                    ...
                    item.remove().then(function () {
                        return _this18.podcast.items = _.reject(_this18.podcast.items, function (elem) {
                            return elem.id === item.id;
                        });
                    }).then(function () {
                        return _this18.playlistService.remove(item);
                    }).then(function () {
                        return _this18.loadPage();
                    });
                }
            },
            {
                ...
                value: function reset(item) {
                    var _this19 = this;
                    return item.reset().then(function (itemReseted) {
                        var itemInList = _.find(_this19.podcast.items, { id: itemReseted.id });
                        _.assign(itemInList, itemReseted);
                        return itemInList;
                    }).then(function (itemToRemove) {
                        return _this19.playlistService.remove(itemToRemove);
                    });
                }
            },
            {
    ...
    var PodcastDetailsStatsCtrl = function () {
        function PodcastDetailsStatsCtrl($scope, $q, podcastService) {
            ...
            $scope.$on('podcastItems:refresh', function () {
                return _this22.generateChartData();
            });
        }
